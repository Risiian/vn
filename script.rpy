...
init python:
    def big_tag(tag, argument, contents):
        ...
        renpy.play("smack1.ogg",channel=soundmain)
    ...
    config.custom_text_tags["fb"] = fbtag
#\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
line detu "sdfsdfsfsdfsfasdfasfasdf"
line detu AAAAAA ZFB BBBBBBB{w=.3}BBBBBBB ZFB ZWS CCCCCCCCCCCCCC ZWS DDDDDDDDD ZFB EEEEEEEEEEEE ZFB FFFFFFFFFFFFFFFF!
...
line detu "IM THE MCFUGGIN NIGGA AAAAAAAAYYYYYYY" {w=.5}said the man who was indeed the nigga.
